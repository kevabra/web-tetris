...
function gameOver() {
  ...
  let finished_score = score;
  let finished_level = level;
  score = 0;
  level = 1;
  rowsCleared = 0;
  scoreElement.textContent = score;
  ...
  // Update user game history and global leaderboard
  updateGameHistoryAndLeaderboard(finished_score, finished_level);
}
